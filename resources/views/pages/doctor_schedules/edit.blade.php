                ...
                <div class="card">
                    <form action="{{ route('doctors.update', $doctor) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Photo</label>
                                <img style="border-radius: 50%; padding:10px; width:20px" class="rounded-full" src={{ Illuminate\Support\Str::startsWith($doctor->photo, 'https://') ? $doctor->photo : (Illuminate\Support\Str::startsWith($doctor->photo, '/storage/') ? $doctor->photo : '/images/' . $doctor->photo) }} alt={{$doctor->name}} >
                                @error('doctor_email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
